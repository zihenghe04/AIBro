...
> [v0.6.4 macOS 预览版已发布](https://github.com/zihenghe04/AIBro/releases/tag/v0.6.4)：提供 Apple Silicon DMG、对应源码与校验文件，修复大尺寸 PDF 与补传材料时的会话衔接。中英文产品短片见 [v0.6.3](https://github.com/zihenghe04/AIBro/releases/tag/v0.6.3)。
