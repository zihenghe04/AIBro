...
"$TEST_DIR/core"
xcrun swiftc native/Sources/AIBro/AgendaCore.swift native/Sources/AIBro/AgendaStore.swift tests/agenda-store.swift -o "$TEST_DIR/store" -framework SwiftUI -framework UserNotifications
"$TEST_DIR/store"
