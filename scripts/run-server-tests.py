...
SERVER_TESTS = (
    ...
    'tests/backend-lifetime.test.py',
    ...
    'tests/wiki-vault.test.py',
    'tests/wiki-migration.test.py',
    'tests/wiki-bundle.test.py',
    'tests/local-commands.test.py',
    'tests/project-jobs.test.py',
    'tests/recovery.test.py',
    'tests/local-projects.test.py',
    'tests/local-file-context.test.py',
    'tests/local-file-edits.test.py',
    'tests/office-documents.test.py',
